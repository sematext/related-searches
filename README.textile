...
* REDIS_HOST - Redis host, ie. _localhost_
* REDIS_PORT - Redis port, ie. _6379_
* TIME_BETWEEN_QUERIES_IN_SECONDS - maximum time between queries in seconds, ie. _20_
* SUGGESTION_THRESHOLD - suggestion threshold, ie. _0.2_
* QUERY_SIMILARITY_ACCEPTANCE_THRESHOLD - query similarity threshold, ie. _0.9_
...
* QUERY_SIMILARITY_ACCEPTANCE_THRESHOLD - query similarity threshold, ie. _0.9_
* QUERY_SIMILARITY_MORE_SIMILAR - boolean, set to _true_ will result in suggesting similar queries according to the given _QUERY_SIMILARITY_ACCEPTANCE_THRESHOLD_
* TEXT_SIMILARITY_BOOST - boost related to text similarity, ie. _0.2_
* TIME_AND_CLICK_BOOST - boost related to clicks, ie. _2.0_
